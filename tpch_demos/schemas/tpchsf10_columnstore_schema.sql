-- Generated from [tpchsf10_columnstore] on 2026-07-19T22:35:08.0768900Z
...
IF SCHEMA_ID(N'hp') IS NULL EXEC(N'CREATE SCHEMA [hp]');
GO

IF SCHEMA_ID(N'ext') IS NULL EXEC(N'CREATE SCHEMA [ext]');
GO

CREATE TABLE [hp].[region]
(
...
ALTER TABLE [rs].[customer] ADD CONSTRAINT [customer_pk] PRIMARY KEY CLUSTERED ([c_custkey] ASC);
GO

ALTER TABLE [rs].[nation] ADD CONSTRAINT [nation_pk] PRIMARY KEY CLUSTERED ([n_nationkey] ASC);
GO

ALTER TABLE [rs].[orders] ADD CONSTRAINT [orders_pk] PRIMARY KEY NONCLUSTERED ([o_orderkey] ASC) WITH (FILLFACTOR = 95);
GO

ALTER TABLE [rs].[part] ADD CONSTRAINT [part_pk] PRIMARY KEY CLUSTERED ([p_partkey] ASC);
GO
...
ALTER TABLE [rs].[region] ADD CONSTRAINT [region_pk] PRIMARY KEY CLUSTERED ([r_regionkey] ASC);
GO

ALTER TABLE [rs].[supplier] ADD CONSTRAINT [supplier_pk] PRIMARY KEY CLUSTERED ([s_suppkey] ASC);
GO
...
CREATE CLUSTERED INDEX [l_shipdate_ind] ON [rs].[lineitem] ([l_shipdate] ASC) WITH (FILLFACTOR = 95);
GO
...
CREATE NONCLUSTERED INDEX [l_orderkey_ind] ON [rs].[lineitem] ([l_orderkey] ASC) WITH (FILLFACTOR = 95);
GO

CREATE NONCLUSTERED INDEX [l_partkey_ind] ON [rs].[lineitem] ([l_partkey] ASC) WITH (FILLFACTOR = 95);
GO
...
CREATE NONCLUSTERED INDEX [n_regionkey_ind] ON [rs].[nation] ([n_regionkey] ASC) WITH (FILLFACTOR = 100);
GO

CREATE CLUSTERED INDEX [o_orderdate_ind] ON [rs].[orders] ([o_orderdate] ASC) WITH (FILLFACTOR = 95);
GO
...
CREATE NONCLUSTERED INDEX [ps_suppkey_ind] ON [rs].[partsupp] ([ps_suppkey] ASC) WITH (FILLFACTOR = 100);
GO
...
CREATE NONCLUSTERED INDEX [s_nationkey_ind] ON [rs].[supplier] ([s_nationkey] ASC) WITH (FILLFACTOR = 100);
GO
