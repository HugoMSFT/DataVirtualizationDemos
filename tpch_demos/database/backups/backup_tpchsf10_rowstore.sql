...
IF DB_ID(N'tpchsf10_rowstore') IS NULL
    THROW 50102, 'Database tpchsf10_rowstore does not exist.', 1;

BACKUP DATABASE [tpchsf10_rowstore]
TO URL = N'https://tpcpublicstorage.blob.core.windows.net/tpch/tpchsf10_rowstore.bak'
WITH
    COPY_ONLY,
    COMPRESSION,
    CHECKSUM,
    ...
    NAME = N'tpchsf10_rowstore full backup',
...
WHERE database_name = N'tpchsf10_rowstore'
  AND type = N'D'
