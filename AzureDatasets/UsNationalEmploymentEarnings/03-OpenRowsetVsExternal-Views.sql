...
--         * dbo.vw_UsNationalEmploymentEarnings_OpenRowset  -> OPENROWSET (ad-hoc, schema via WITH)
--         * dbo.vw_UsNationalEmploymentEarnings_External    -> the external table from script 02
-- Prerequisite: run 02-ExternalTable.sql first (creates dbo.UsNationalEmploymentEarnings_External).
-- Run this script connected to the [UsNationalEmploymentEarnings] database.
-- =============================================================================

-- =============================================================================
-- Step 1: View over OPENROWSET
-- =============================================================================
CREATE OR ALTER VIEW dbo.vw_UsNationalEmploymentEarnings_OpenRowset
AS
SELECT
    [data_type_code],
    [industry_code],
...
-- =============================================================================
CREATE OR ALTER VIEW dbo.vw_UsNationalEmploymentEarnings_External
AS
SELECT * FROM dbo.UsNationalEmploymentEarnings_External;
GO

-- =============================================================================
-- Step 3: Same shape, two engines - row counts should match
-- =============================================================================
SELECT COUNT(*) AS rows_via_openrowset FROM dbo.vw_UsNationalEmploymentEarnings_OpenRowset;
GO
SELECT COUNT(*) AS rows_via_external   FROM dbo.vw_UsNationalEmploymentEarnings_External;
GO

-- =============================================================================
-- Step 4: Compare - Observations and average value by industry
-- =============================================================================
...
FROM dbo.vw_UsNationalEmploymentEarnings_OpenRowset
...
SELECT TOP 20
    ...
    COUNT(*)                              AS observations,
    CAST(AVG(value) AS DECIMAL(18,3))     AS avg_value
FROM dbo.vw_UsNationalEmploymentEarnings_External
GROUP BY industry_name
ORDER BY observations DESC;
GO
...
-- Cleanup (optional)
-- =============================================================================
-- DROP VIEW IF EXISTS dbo.vw_UsNationalEmploymentEarnings_OpenRowset;
-- DROP VIEW IF EXISTS dbo.vw_UsNationalEmploymentEarnings_External;
-- GO
