...
-- Run this script connected to the [UsNationalEmploymentEarnings] database (created in 01).
-- =============================================================================

-- =============================================================================
-- Step 1: External data source (points at the dataset's storage folder)
-- =============================================================================
IF NOT EXISTS (SELECT 1 FROM sys.external_data_sources WHERE name = 'UsNationalEmploymentEarningsDS')
    CREATE EXTERNAL DATA SOURCE UsNationalEmploymentEarningsDS
    WITH (
        LOCATION = 'abs://laborstatisticscontainer@azureopendatastorage.blob.core.windows.net/ehe_national'
    );
GO
...
IF OBJECT_ID('dbo.UsNationalEmploymentEarnings_External') IS NOT NULL
    DROP EXTERNAL TABLE dbo.UsNationalEmploymentEarnings_External;
GO

CREATE EXTERNAL TABLE dbo.UsNationalEmploymentEarnings_External
(
...
WITH (
    DATA_SOURCE = UsNationalEmploymentEarningsDS,
    LOCATION    = '/',
...
CREATE STATISTICS ST_UsNationalEmploymentEarnings_series_id ON dbo.UsNationalEmploymentEarnings_External ([series_id]) WITH FULLSCAN;
CREATE STATISTICS ST_UsNationalEmploymentEarnings_year ON dbo.UsNationalEmploymentEarnings_External ([year]) WITH FULLSCAN;
CREATE STATISTICS ST_UsNationalEmploymentEarnings_period ON dbo.UsNationalEmploymentEarnings_External ([period]) WITH FULLSCAN;
GO
...
-- =============================================================================
SELECT TOP 50 *
FROM dbo.UsNationalEmploymentEarnings_External;
GO
...
WHERE c.object_id = OBJECT_ID('dbo.UsNationalEmploymentEarnings_External')
