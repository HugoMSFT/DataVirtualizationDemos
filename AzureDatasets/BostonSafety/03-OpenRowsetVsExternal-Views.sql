...
--         * dbo.vw_BostonSafety_OpenRowset  -> OPENROWSET (ad-hoc, schema via WITH)
--         * dbo.vw_BostonSafety_External    -> the external table from script 02
-- Prerequisite: run 02-ExternalTable.sql first (creates dbo.BostonSafety_External).
-- Run this script connected to the [BostonSafety] database.
-- =============================================================================

-- =============================================================================
-- Step 1: View over OPENROWSET
-- =============================================================================
CREATE OR ALTER VIEW dbo.vw_BostonSafety_OpenRowset
AS
SELECT
    [dataType],
    [dataSubtype],
...
-- =============================================================================
CREATE OR ALTER VIEW dbo.vw_BostonSafety_External
AS
SELECT * FROM dbo.BostonSafety_External;
GO

-- =============================================================================
-- Step 3: Same shape, two engines - row counts should match
-- =============================================================================
SELECT COUNT(*) AS rows_via_openrowset FROM dbo.vw_BostonSafety_OpenRowset;
GO
SELECT COUNT(*) AS rows_via_external   FROM dbo.vw_BostonSafety_External;
GO
...
-- Cleanup (optional)
-- =============================================================================
-- DROP VIEW IF EXISTS dbo.vw_BostonSafety_OpenRowset;
-- DROP VIEW IF EXISTS dbo.vw_BostonSafety_External;
-- GO
